...
function normalizeLegacyOptionsArgs(e2, t2, i2, s2) {
  const n = void 0 !== s2;
  return n || void 0 !== i2 ? n ? (console.warn(e2), t2.body = Object.assign({}, t2.body, i2), t2.query = Object.assign({}, t2.query, s2), t2) : t2 = Object.assign(t2, i2) : t2;
}
var AdminService = class extends CrudService {
  ...
  authWithPassword(e2, t2, i2, s2) {
    ...
    return n = normalizeLegacyOptionsArgs("This form of authWithPassword(email, pass, body?, query?) is deprecated. Consider replacing it with authWithPassword(email, pass, options?).", n, i2, s2), this.client.send(this.baseCrudPath + "/auth-with-password", n).then(this.authResponse.bind(this));
  }
  authRefresh(e2, t2) {
    let i2 = { method: "POST" };
