        ...
        <div class="flex flex-col gap-y-4">
          ...
          <div>
            <md-field ref="division_id" :class="{ 'md-invalid': v$.formData.division_id.$error }">
              ...
              <md-select  placeholder="Pasirinkite padalinį" v-model="formData.division_id"
                name="font" id="division" @input="handleDivisions(formData.division_id)"
                @md-opened="handleShow(true, `division`)" @md-closed="handleShow(false, `division`)">
                <md-option value="">
            ...
            <md-field ref="department_id">
              ...
              <md-select placeholder="Pasirinkite skyrių" 
                @input="handleDepartment(formData.department_id)" v-model="formData.department_id" name="department"
                id="department" @md-opened="handleShow(true, `department`)" @md-closed="handleShow(false, `department`)">
                <md-option value="">
            ...
            <md-field ref="group_id">
              ...
              <md-select  placeholder="Pasirinkite grupę" v-model="formData.group_id"
                name="group" id="group" @md-opened="handleShow(true, `group`)" @md-closed="handleShow(false, `group`)">
